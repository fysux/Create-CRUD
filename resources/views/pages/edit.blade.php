    ...
    <div class="container">
        <form action="{{ route('barang.update', $data->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="description" name="keterangan" value="{{ $data->keterangan }}">
            </div>
            <div class="mb-3">
                <label for="quantity" class="form-label">Stok</label>
                <input type="number" class="form-control" id="quantity" name="stok" value="{{ $data->stok }}">
            </div>
            <div class="mb-3">
